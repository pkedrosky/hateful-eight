...
function renderImpact(frame) {
  ...
  impactBoxEl.innerHTML = `
    <div class="impact-item">
      ...
      <div class="impact-value">${fmtSigned(h8Pts, 1)} pts</div>
      <div class="impact-sub">${fmtSigned(h8Pct, 2)}% of S&P</div>
    </div>
    <div class="impact-item">
      <div class="impact-label">Rest Of S&P 500</div>
      <div class="impact-value">${fmtSigned(otherPts, 1)} pts</div>
      <div class="impact-sub">${fmtSigned(totalPts !== 0 ? (h8Pts / totalPts) * 100 : 0, 1)}% H8 share of net move</div>
    </div>
    <div class="impact-item">
      <div class="impact-label">Net Modeled Move</div>
      <div class="impact-value">${fmtSigned(totalPts, 1)} pts</div>
      <div class="impact-sub">${fmtSigned(totalPct, 2)}% over selected window</div>
    </div>
  `;
}
function postHeight() {
